...
def main():
    ...
    parser.add_argument("--jsonl_path", type=str, default="/data/Projects/Qwen3-TTS/data/test_npc.jsonl", 
                        help="Path to JSONL input file (default: test_custon.jsonl)")
    parser.add_argument("--output_dir", type=str, default="./output/voicedesign_npc", 
    ...
    if args.model_path is None:
        MODEL_PATH = os.path.join(PROJECT_ROOT, "pretrained_models", "Qwen3-TTS-12Hz-1.7B-VoiceDesign")
    else:
