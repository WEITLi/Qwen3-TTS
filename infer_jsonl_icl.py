...
def main():
    ...
    tts = Qwen3TTSModel.from_pretrained(
        "/data/Projects/Qwen3-TTS/exp/exp_l50/sft_lr2ef6_8spk_full-1.7B-dropout/checkpoint-epoch-10",
        device_map=device,
    ...
    output_dir = "./output/sft_1.7B_lr2ef6-e10-0212"
    ...
    with open(jsonl_path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            if line:
                ...
                # new    
                if "ref_text" in data:
                    ref_texts.append(data["ref_text"])
                if "ref_audio" in data and data["ref_audio"]:  
                    ref_audios.append(data["ref_audio"])
                else:
                    print(f"Warning: 缺少 ref_audio: key={data.get('key')}")
